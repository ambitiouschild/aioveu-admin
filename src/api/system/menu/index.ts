...
export function listRoutes() {
  return request({
    url: "/aioveu-system/api/v1/menus/routes",
    method: "get",
  });
}
...
export function listMenus(queryParams: MenuQuery): AxiosPromise<MenuVO[]> {
  return request({
    url: "/aioveu-system/api/v1/menus",
    method: "get",
    params: queryParams,
  });
}
...
export function getMenuOptions(): AxiosPromise<OptionType[]> {
  return request({
    url: "/aioveu-system/api/v1/menus/options",
    method: "get",
  });
}
...
export function getMenuForm(id: number): AxiosPromise<MenuForm> {
  return request({
    url: "/aioveu-system/api/v1/menus/" + id + "/form",
    method: "get",
  });
}
...
export function updateMenu(id: string, data: MenuForm) {
  return request({
    url: "/aioveu-system/api/v1/menus/" + id,
    method: "put",
    data: data,
  });
}
