...
export function getDictTypePage(
  ...
  return request({
    url: "/aioveu-system/api/v1/dict/types/page",
    method: "get",
    params: queryParams,
  });
}
...
export function getDictTypeForm(id: number): AxiosPromise<DictTypeForm> {
  return request({
    url: "/aioveu-system/api/v1/dict/types/" + id + "/form",
    method: "get",
  });
}
...
export function addDictType(data: DictTypeForm) {
  return request({
    url: "/aioveu-system/api/v1/dict/types",
    method: "post",
    data: data,
  });
}
...
export function updateDictType(id: number, data: DictTypeForm) {
  return request({
    url: "/aioveu-system/api/v1/dict/types/" + id,
    method: "put",
    data: data,
  });
}
...
export function deleteDictTypes(ids: string) {
  return request({
    url: "/aioveu-system/api/v1/dict/types/" + ids,
    method: "delete",
  });
}
...
export function getDictOptions(typeCode: string): AxiosPromise<OptionType[]> {
  return request({
    url: "/aioveu-system/api/v1/dict/types/" + typeCode + "/items",
    method: "get",
  });
}
...
export function getDictPage(
  ...
  return request({
    url: "/aioveu-system/api/v1/dict/page",
    method: "get",
    params: queryParams,
  });
}
...
export function getDictFormData(id: number): AxiosPromise<DictForm> {
  return request({
    url: "/aioveu-system/api/v1/dict/" + id + "/form",
    method: "get",
  });
}
...
export function updateDict(id: number, data: DictForm) {
  return request({
    url: "/aioveu-system/api/v1/dict/" + id,
    method: "put",
    data: data,
  });
}
...
export function deleteDict(ids: string) {
  return request({
    url: "/aioveu-system/api/v1/dict/" + ids,
    method: "delete",
  });
}
