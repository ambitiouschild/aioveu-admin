...
export function getDeptOptions(): AxiosPromise<OptionType[]> {
  return request({
    url: "/aioveu-system/api/v1/dept/options",
    method: "get",
  });
}
...
export function getDeptForm(id: number): AxiosPromise<DeptForm> {
  return request({
    url: "/aioveu-system/api/v1/dept/" + id + "/form",
    method: "get",
  });
}
...
export function updateDept(id: number, data: DeptForm) {
  return request({
    url: "/aioveu-system/api/v1/dept/" + id,
    method: "put",
    data: data,
  });
}
...
export function deleteDept(ids: string) {
  return request({
    url: "/aioveu-system/api/v1/dept/" + ids,
    method: "delete",
  });
}
